...
abstract class ForeignKeyAction extends \PHPTools\Enum
{
	 ...
	 * Some database systems have deferred checks, and NO ACTION is a deferred check. In MySQL, foreign key constraints are checked immediately, so NO ACTION is the same as RE
	 * Note: Cascaded foreign key actions do not activate triggers.STRICT. 
	 */
